...
# (-1) All specific dates are potentially identifying, we should remove.
...
# (-2) Platelets & WBCs are character, need to be converted to numeric.
# (-1) Need to save resulting table using write.csv()
